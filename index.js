...
var createAndSavePerson = (done) => {
  var james = new Person({name: "James", age: 34, favoriteFoods: ["water", "choco"]});
...
var findEditThenSave = function(personId, done) {
  ...
  Person.findById({ _id: personId }, (err,data) => {
    ...
    // console.log(data) // checking the content of data after adding 
    data.save((err,data) => { // saving the change
       if(err) console.err(err)
      done(null, data);
    })
  })
